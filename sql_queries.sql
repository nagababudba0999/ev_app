...
VALUES
    ...
    ('EV-102', 'Front Gate', 'Sivaji Building', '2024-09-24', 40, 40),
    ('EV-103', 'Front Gate', 'Boys Hostel', '2024-09-24', 60, 60),
    ('EV-104', 'Back Gate', 'Front Gate', '2024-09-25', 55, 55),
    ('EV-105', 'Back Gate', 'Sivaji Building', '2024-09-25', 45, 45),
    ('EV-105', 'Back Gate', 'Boys Hostel', '2024-09-25', 45, 45),
    ('EV-105', 'Sivaji Building', 'Front Gate', '2024-09-25', 45, 45),
    ('EV-105', 'Sivaji Building', 'Back Gate', '2024-09-25', 45, 45),
    ('EV-105', 'Sivaji Building', 'Boys Hostel', '2024-09-25', 45, 45);
